...
int cargarArchivoUno(char* archivo){
    ...
    if(archivoFuncion!=NULL){
        stPersona personaFuncion1 = cargarDatos("Eduardo",33,"Murga",8794);
        fwrite(&personaFuncion1,sizeof(personaFuncion1),1,archivoFuncion);
        contador++;
        stPersona personaFuncion2 = cargarDatos("Esteban",18,"Vida",4501);
        fwrite(&personaFuncion2,sizeof(personaFuncion2),1,archivoFuncion);
        contador++;
        stPersona personaFuncion3 = cargarDatos("Agostina",24,"Ave",7789);
        fwrite(&personaFuncion3,sizeof(personaFuncion3),1,archivoFuncion);
        contador++;
        stPersona personaFuncion4 = cargarDatos("Chano",45,"Ave",6785);
        fwrite(&personaFuncion4,sizeof(personaFuncion4),1,archivoFuncion);
        contador++;
        stPersona personaFuncion5 = cargarDatos("Gaston",45,"Ave",8770);
...
int cargarArchivoDos(char* archivo){
    ...
    stPersona personaFuncion;
    if(archivoFuncion!=NULL){
        stPersona personaFuncion1 = cargarDatos("Jose",29,"Murga",6757);
        fwrite(&personaFuncion1,sizeof(personaFuncion1),1,archivoFuncion);
        contador++;
        stPersona personaFuncion2 = cargarDatos("Ariel",25,"Ave",4897);
        fwrite(&personaFuncion2,sizeof(personaFuncion2),1,archivoFuncion);
        contador++;
        stPersona personaFuncion3 = cargarDatos("Isidro",35,"Vida",7454);
        fwrite(&personaFuncion3,sizeof(personaFuncion3),1,archivoFuncion);
        contador++;
        stPersona personaFuncion4 = cargarDatos("Joaquin",29,"Ave",6542);
        fwrite(&personaFuncion4,sizeof(personaFuncion4),1,archivoFuncion);
        contador++;
        stPersona personaFuncion5 = cargarDatos("Federica",20,"Ave",8653);
        fwrite(&personaFuncion5,sizeof(personaFuncion5),1,archivoFuncion);
        contador++;
        fclose(archivoFuncion);
    }else{
